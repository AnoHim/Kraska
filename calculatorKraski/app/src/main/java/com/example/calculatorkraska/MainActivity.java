    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Создайте DecimalFormat с форматом "#.##" для двух знаков после запятой
                ...
                String formattedResult = decimalFormat.format(totalPaintWithReserve);

                // Вывод результата
                textResult.setText("Итоговое количество краски: " + formattedResult + " литров");
